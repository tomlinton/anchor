...
* cli: Emits a warning when a program is discovered with mismatched versions of Anchor crates from the CLI version ([#1690](https://github.com/project-serum/anchor/pull/1690)).
